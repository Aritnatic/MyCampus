...
const TabsList = forwardRef(({ children, className = '', ...props }, ref) => (
  <div
    ...
    className={`inline-flex items-center gap-1 p-1 bg-gray-100 rounded-xl dark:bg-gray-800/60 ${className}`}
    {...props}
  >
    {children}
  </div>
  ...
  return (
    <button
      ...
      className={`
        ...
        ${isActive ? 'bg-white text-primary-600 shadow-sm dark:bg-gray-700 dark:text-primary-400' : 'text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-200'}
